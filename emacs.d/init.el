...
(setq bibtex-command (cond ((string-match "uplatex\\|ptex2pdf" tex-command) "/Library/TeX/texbin/upbibtex")
						   ((string-match "lualatex\\|luajitlatex\\|xelatex" tex-command) "/Library/TeX/texbin/bibtexu")
						   ((string-match "pdflatex" tex-command) "/Library/TeX/texbin/bibtex")
						   (t "/Library/TeX/texbin/upbibtex")))
(setq makeindex-command (cond ((string-match "uplatex\\|ptex2pdf" tex-command) "/Library/TeX/texbin/mendex")
							  ((string-match "lualatex\\|luajitlatex\\|xelatex" tex-command) "/Library/TeX/texbin/texindy")
							  ((string-match "pdflatex" tex-command) "/Library/TeX/texbin/makeindex")
